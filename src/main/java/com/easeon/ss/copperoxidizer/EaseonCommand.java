...
public class EaseonCommand {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register(CommandManager.literal("easeon")
                ...
                .then(CommandManager.literal("copperoxidizer")
                        // 조회
                        .executes(ctx -> {
                            ...
                            ctx.getSource().sendFeedback(
                                    () -> Text.literal("Easeon ")
                                            ...
                                            .append(Text.literal("Copper Oxidizer is currently: ")
                                ...
                                .executes(ctx -> {
                                    if (Easeon.CONFIG.isEnabled()) {
                                        ctx.getSource().sendFeedback(
                                                () -> Text.literal("Easeon ")
                                                        .formatted(Formatting.YELLOW)
                                                        .append(Text.literal("Copper Oxidizer is already enabled!")
                                                                .formatted(Formatting.YELLOW)),
                                                false
                                        );
                                    } else {
                                        ...
                                        ctx.getSource().sendFeedback(
                                                () -> Text.literal("Easeon ")
                                                        .formatted(Formatting.YELLOW)
                                                        .append(Text.literal("Copper Oxidizer has been ")
                                                                .formatted(Formatting.WHITE))
                                ...
                                .executes(ctx -> {
                                    if (!Easeon.CONFIG.isEnabled()) {
                                        ctx.getSource().sendFeedback(
                                                () -> Text.literal("Easeon ")
                                                        .formatted(Formatting.YELLOW)
                                                        .append(Text.literal("Copper Oxidizer is already disabled!")
                                                                .formatted(Formatting.YELLOW)),
                                                false
                                        );
                                    } else {
